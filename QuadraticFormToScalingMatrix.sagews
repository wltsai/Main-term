# the function "Formtoscaling" is related to the quadratic form [a,b,c] and the corresponding scaling matrix (Gamma_0(6)) which is given by
#M. Dewar and R. Murty, "A derivation of the Hardy-Ramanujan formula from an arithmetic formula", Proc. Amer. Math. Soc., 141 (2012), 1903-1911.
